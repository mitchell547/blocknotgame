require "ecs/ECS_Systems"
require "ecs/ECS_Components"
...
-- BUG!!!
-- problem with deleting entities and unsubscribing them from systems!
...
function ECSManager()
	...
	local function deleteMarkedObjects()
		for k, v in ipairs(entitiesToDelete) do
            --[[for i, system in pairs(systems) do
                if system.subscribers[v] then
                    system.subscribers[v] = nil
                end
            end]]--
			t_remove(entities, v)
		end
